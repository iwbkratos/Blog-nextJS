   ...
   async function sendMessageHandler(event){
    ...
    return (
        <section  className={classes.contact}>
            ...
            <form className={classes.form} onSubmit={sendMessageHandler}>
                <div className={classes.controls}>
                    ...
                    <div className={classes.control}>
                        ...
                        <input type="text" id="name" required value={enteredName} onChange={(event)=>setEnterdName(event.target.value)}/>
                    </div>
                </div>
                <div className={classes.control}>
            ...
            {notification&&(<Notification statu={notification.status} title={notification.title} message={notification.message}/>)}
        </section>
    )
}
